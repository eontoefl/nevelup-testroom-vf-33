...
function _getV3Table(sectionType) {
    if (window.courseMode === 'australia' && (sectionType === 'intro-book-aus' || sectionType === 'vocab' || sectionType === 'reading' || sectionType === 'listening' || sectionType === 'brainstorming' || sectionType === 'intwrt')) {
