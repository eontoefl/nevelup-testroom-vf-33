...
const AUS_SCHEDULE_DATA = {
    ...
    standard: {
        ...
        week7: {
            ...
            friday: ["내벨업보카 46, 47pg", "독스 TOPIC 11", "토라 1", "브레인스토밍 Day 24"],
            saturday: []
        },
        week8: {
            sunday: ["내벨업보카 48, 49, 50pg", "리딩17", "토라 2", "브레인스토밍 Day 25"],
            monday: ["내벨업보카 51, 52pg", "독스 TOPIC 12", "토라 3", "브레인스토밍 Day 26"],
            tuesday: ["내벨업보카 53, 54, 55pg", "리스닝34", "리스닝35", "토라 4", "브레인스토밍 Day 27"],
            wednesday: ["내벨업보카 56, 57pg", "독스 TOPIC 13", "토라 5", "브레인스토밍 Day 28"],
            thursday: ["내벨업보카 58, 59pg", "독스 TOPIC 14", "토라 6", "브레인스토밍 Day 29"],
            friday: ["내벨업보카 60, 61pg", "독스 TOPIC 15", "토라 7", "브레인스토밍 Day 30"],
            saturday: []
        }
    }
};
