...
const AUS_SCHEDULE_DATA = {
    ...
    standard: {
        ...
        week4: {
            ...
            monday: ["내벨업보카 51, 52pg", "통스1", "토라1", "브레인스토밍 Day 2"],
            tuesday: ["내벨업보카 53, 54pg", "리딩8", "리스닝14", "리스닝15", "브레인스토밍 Day 3"],
            wednesday: ["내벨업보카 55, 56, 57pg", "통스2", "토라2", "브레인스토밍 Day 4"],
            thursday: ["내벨업보카 58, 59pg", "리딩9", "리스닝16", "리스닝17", "리스닝18", "브레인스토밍 Day 5"],
            friday: ["내벨업보카 60, 61pg", "통스3", "토라3", "브레인스토밍 Day 6"],
            saturday: []
        },
        week5: {
            sunday: ["내벨업보카 5, 6, 7pg", "리딩10", "통스 TOPIC 1", "브레인스토밍 Day 7"],
            monday: ["내벨업보카 8, 9pg", "통스4", "토라4", "브레인스토밍 Day 8"],
            tuesday: ["내벨업보카 10, 11, 12pg", "리딩11", "리스닝19", "리스닝20", "브레인스토밍 Day 9"],
            wednesday: ["내벨업보카 13, 14pg", "통스 TOPIC 2", "통스 TOPIC 3", "브레인스토밍 Day 10"],
            thursday: ["내벨업보카 15, 16pg", "리딩12", "리스닝21", "리스닝22", "리스닝23", "브레인스토밍 Day 11"],
            friday: ["내벨업보카 17, 18, 19pg", "통스5", "토라5", "브레인스토밍 Day 12"],
            saturday: []
        },
        week6: {
            sunday: ["내벨업보카 20, 21pg", "리딩13", "브레인스토밍 Day 13"],
            monday: ["내벨업보카 22, 23, 24pg", "리스닝24", "리스닝25", "통스 TOPIC 4", "브레인스토밍 Day 14"],
            tuesday: ["내벨업보카 25, 26pg", "통스6", "토라6", "브레인스토밍 Day 15"],
            wednesday: ["내벨업보카 27, 28pg", "리딩14", "통스 TOPIC 5", "브레인스토밍 Day 16"],
            thursday: ["내벨업보카 29, 30, 31pg", "통스 TOPIC 6", "리스닝26", "리스닝27", "리스닝28", "브레인스토밍 Day 17"],
            friday: ["내벨업보카 32, 33pg", "통스7", "토라7", "브레인스토밍 Day 18"],
            saturday: []
        },
        week7: {
            sunday: ["내벨업보카 34, 35pg", "리딩15", "통스 TOPIC 7", "브레인스토밍 Day 19"],
            monday: ["내벨업보카 36, 37, 38pg", "리스닝29", "리스닝30", "통스 TOPIC 8", "브레인스토밍 Day 20"],
            tuesday: ["내벨업보카 39, 40pg", "통스8", "토라8", "브레인스토밍 Day 21"],
            wednesday: ["내벨업보카 41, 42, 43pg", "리딩16", "통스 TOPIC 9", "브레인스토밍 Day 22"],
            thursday: ["내벨업보카 44, 45pg", "리스닝31", "리스닝32", "리스닝33", "통스 TOPIC 10", "브레인스토밍 Day 23"],
            friday: ["내벨업보카 46, 47pg", "통스 TOPIC 11", "토라 1", "브레인스토밍 Day 24"],
            saturday: []
        },
        week8: {
            sunday: ["내벨업보카 48, 49, 50pg", "리딩17", "토라 2", "브레인스토밍 Day 25"],
            monday: ["내벨업보카 51, 52pg", "통스 TOPIC 12", "토라 3", "브레인스토밍 Day 26"],
            tuesday: ["내벨업보카 53, 54, 55pg", "리스닝34", "리스닝35", "토라 4", "브레인스토밍 Day 27"],
            wednesday: ["내벨업보카 56, 57pg", "통스 TOPIC 13", "토라 5", "브레인스토밍 Day 28"],
            thursday: ["내벨업보카 58, 59pg", "통스 TOPIC 14", "토라 6", "브레인스토밍 Day 29"],
            friday: ["내벨업보카 60, 61pg", "통스 TOPIC 15", "토라 7", "브레인스토밍 Day 30"],
            saturday: []
        }
    }
};
