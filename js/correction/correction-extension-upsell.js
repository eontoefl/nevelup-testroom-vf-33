...
function _ext_renderApplied(host, req) {
    ...
    host.innerHTML =
        ...
        '<div class="ext-step"><span class="ext-step-n">3</span><span>다음 일요일부터 13~24세션이 바로 열립니다</span>' +
        '<a class="ext-kakao-link" href="' + EXT_KAKAO_URL + '" target="_blank" rel="noopener"><i class="fas fa-comment-dots"></i> 카톡 문의</a></div>' +
        '</div>' +
        '</div>';
}
